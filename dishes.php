        ...
        <div class="page-wrapper">
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/new-bg-logo.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
						...
						<?php  // display values and item of food/dishes
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<!--  <input class="b-r-0" type="number" name="quantity"  style="margin-left:30px;" value="1" width="10%" height="15%" /> -->
                                          <input  type="number" name="quantity" value="1"  style="width: 60px;margin-left:30px;">
