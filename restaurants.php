...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="inner-page-hero bg-image" data-image-src="images/download.png">
 ...
 <section class="featured-restaurants">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Discounts and Offers</h4> </div>
                    </div>
                    <div class="col-sm-8">
                  ...
                  $res= mysqli_query($db,"select distinct discount from restaurant ORDER by discount asc");
                        while($row=mysqli_fetch_array($res))
                      {
                      echo '<li><a href="#" data-filter=".'.$row['discount'].'"> '.$row['discount'].'%</a> </li>';
                      }
                  ?>
            ...
            $ress= mysqli_query($db,"select * from restaurant");  
                        while($rows=mysqli_fetch_array($ress))
                      {
                          ...
                          $query= mysqli_query($db,"select * from restaurant where discount='".$rows['discount']."' ");
                           $rowss=mysqli_fetch_array($query);
            
                           echo ' <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all '.$rowss['discount'].'">
